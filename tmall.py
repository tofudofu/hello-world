...
def printF1Score(recommend):
    ...
    getdata2=(("规则",round(100 * precision, 2),round(100 * recall, 2),round(100 * 2 * precision * recall / (precision + recall), 2)),)
    return getdata2


def getDiffDay(d1, d2):
    d1 = datetime.date(2016, d1[0], d1[1])
    d2 = datetime.date(2016, d2[0], d2[1])
    day = (d2 - d1).days
    return day
